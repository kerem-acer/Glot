...
public readonly partial struct LinkedTextUtf16Span
{
    ...
    /// <see cref="LinkedTextUtf16Span"/>. First and last segments are sliced
    /// to the span boundaries.
    /// </summary>
    public struct SegmentEnumerator
    {
        ...
        int _currentSegment;
        ReadOnlyMemory<char> _current;
        bool _started;

        internal SegmentEnumerator(LinkedTextUtf16Span span)
        {
            _data = span._data;
